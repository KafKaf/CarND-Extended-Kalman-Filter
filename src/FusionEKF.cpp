...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  float dt_3 = dt_2 * dt;
  float dt_3_2 = dt_3 / 2;
  float dt_3_2_x = dt_3_2 * noise_ax;
  float dt_3_2_y = dt_3_2 * noise_ay;
  ...
  ekf_.Q_ <<  dt_4_4*noise_ax, 0, dt_3_2_x, 0,
   		     0, dt_4_4*noise_ay, 0, dt_3_2_y,
  		     dt_3_2_x, 0, dt_2*noise_ax, 0,
  		     0, dt_3_2_y, 0, dt_2*noise_ay;
